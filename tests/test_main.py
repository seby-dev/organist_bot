...
class TestSendTelegramAlert:
    def test_sends_message_when_token_and_chat_id_set(self):
        ...
        with patch("main.settings", mock_settings), \
             patch("main._requests.post") as mock_post:
...
class TestMain:
    ...
    def test_per_gig_error_is_isolated(self):
        ...
        good_basic = dict(
            header="Good Gig", organisation="Church", locality="London",
            date="Sunday, March 1, 2026", time="10:00 AM", fee="£120",
    ...
    def test_all_filters_disabled_passes_all_gigs(self):
        ...
        basic = dict(
            header="Test Gig", organisation="Church", locality="London",
            date="Sunday, March 1, 2026", time="10:00 AM", fee="£120",
